...
(function () {
  ...
  // Read the real installed version from Tampermonkey — a hardcoded constant
  // here drifted (badge said v12.16 while @version was 12.21) and made it
  // impossible to tell which version is actually running.
